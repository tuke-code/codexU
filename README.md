...
- 在顶部概览最左侧用“等级徽章 + 指挥半径轨道”展示滚动 28 天 AI 领导力得分和中文 Title；轨道节点对应真实峰值并发，并以 `person.3.fill`、`clock.fill` 展示今日 Agent 与今日 AI 工时。双环紧随其右并保持原尺寸。
- 下方仪表盘支持今日任务、AI 领导力、用量趋势、项目排行和 Skill 使用视图。AI 领导力始终评估 Codex 与 Claude Code 的合计表现，详情仅切换今日 / 7 天 / 28 天，展示管理半径、劳动力杠杆、编排能力、自主运行、并发时间线和项目贡献。
